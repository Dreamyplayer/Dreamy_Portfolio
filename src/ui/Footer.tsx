const Footer = () => {
  ...
  return (
    <footer className='fixed bottom-0 z-30 flex h-8 w-full items-center justify-center border-t border-gray-300 bg-gray-100 px-4 text-xs text-[#647488] dark:border-neutral-700 dark:bg-neutral-800/30 md:lg:flex-col lg:items-start lg:text-base'>
